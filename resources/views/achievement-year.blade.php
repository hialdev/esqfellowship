...
<section class="achievement-page sec-pad pb-5">
    <div class="container">
        ...
        <h1 class="text-big light-text-gold pb-3">Our Achievements</h1>
        <h2 class="bg-gold text-white p-3 px-4 d-inline-block rounded-5 fs-3 mb-4">{{$year}}</h2>
        <form action="{{route('achievement.search')}}" method="GET">
            <div class="d-flex align-items-center justify-content-center gap-3 mb-3">
                <input type="text" class="form-control border-white p-2 px-4 rounded-pill bg-light" name="q" placeholder="Cari dengan Nama Mahasiswa" minlength="3">
