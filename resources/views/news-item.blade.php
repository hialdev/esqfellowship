    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                ...
                <img src="{{Voyager::image($news->image)}}" alt="{{$news->title}} Image" class="d-block w-100 mb-5" style="border-radius: 25px; aspect-ratio:16/9; object-fit:cover">
            ...
            <div class="col-lg-4">
                ...
                <a href="{{route('news.show', $nl->slug)}}" class="d-flex gap-3 text-dark p-4 rounded bg-light fs-6 mb-3">
                    <img src="{{Voyager::image($nl->title)}}" alt="Image {{$nl->title}}" class="d-block rounded" style="aspect-ratio:16/9; max-height:5em; object-fit:cover;">
