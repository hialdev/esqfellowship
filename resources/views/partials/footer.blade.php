        ...
        <div class="row">
            <div class="col-12 col-md-4 mb-5">
                ...
                <ul data-aos="fade-down" data-aos-duration="1000" class="list-unstyled">
                    <li><a href="https://wa.me/{{setting('contact.wa')}}" class="d-flex pt-3 align-items-center gap-3 text-decoration-none text-white">
                    ...
                    <li><a href="tel:{{setting('contact.telp')}}" class="d-flex pt-3 align-items-center gap-3 text-decoration-none text-white">
                            <div class="d-flex align-items-center justify-content-center">
                    ...
                    <li><a href="mailto:{{setting('contact.mail')}}" class="d-flex pt-3 align-items-center gap-3 text-decoration-none text-white">
                            <div class="d-flex align-items-center justify-content-center">
            ...
            <div class="col-12 col-md-4 mb-5 text-end">
                ...
                <p data-aos="fade-down" data-aos-duration="1000" style="line-height: 32px;">{{setting('contact.address')}}</p>
            </div>
